...
nii_report_info = {
    'name': 'nii',
    'title': 'Nacionalna Informacijska Infrastruktura',
    'description': 'Detalji skupova podataka od strane NII.',
...
publisher_resources_info = {
	...
	'title': u'Resursi izdava\u010Da',
    'description': u'Lista svih skupova podataka i resursa za izdava\u010Da.',
...
feedback_report_info = {
    ...
    'description': 'Zbir povratnih informacija o skupovima podataka.',
...
publisher_activity_report_info = {
	...
	'title': u'Aktivnost izdava\u010Da',
    'description': u'Kvartalna lista skupova podataka kreiranih i ure\u0111ivanih od strane izdava\u010Da.',
    'option_defaults': OrderedDict((('organization', 'cabinet-office'),
                                    ('include_sub_organizations', False),
                                    )),
...
unpublished_report_info = {
    'name': 'unpublished',
    'title': 'Neobjavljeni skupovi podataka',
    'description': u'Svojstva neobjavljenih skupova podataka omogu\u0107enih od izdava\u010Da.',
...
datasets_without_resources_info = {
    ...
    'title': 'Skupovi podataka bez resursa',
    'description': 'Skupovi podataka koji nemaju resurse (URLovi podataka). Isklju\u010Duje neobjavljene.',
    'option_defaults': None,
    'option_combinations': None,
