...
categories = (
				('izvrsna_vlast_ministarstvo',u'Izvršna vlast - Ministarstvo'),
				('izvrsna_vlast_ured_drzavni',u'Izvršna vlast - Državni ured'),
				('izvrsna_vlast_organizacija_drzava',u'Izvršna vlast - Državna upravna organizacija'),
				('izvrsna_vlast_vlada',u'Izvršna vlast - Ured Vlade'),
				('izvrsna_vlast_ured_drzava',u'Izvršna vlast - Ured državne uprave'),
				('lokalna_samouprava',u'Lokalna i područna samouprava'),
				('nizi_sud',u'Sud nižeg stupnja'),
				('poduzece_javnog_interesa',u'Poduzeće od javnog interesa'),
				('pravosudno_tijelo',u'Pravosudno tijelo'),
				('povremeno_tijelo',u'Povremeno, stručno i savjetodavno radno tijelo'),
				('samostalno',u'Samostalno i neovisno tijelo'),
				('ustanova_javnog_sektora',u'Ustanova javnog sektora'),
				('ustavni_sud',u'Ustavni sud i vršno tijelo sudbene vlasti'),
				('zakonodavna_vlast',u'Zakonodavna vlast'),
				('ostalo',u'Ostalo')
			)
#categories = (
