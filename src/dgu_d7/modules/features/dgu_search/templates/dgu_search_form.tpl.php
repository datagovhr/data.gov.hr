    ...
    <div class="left">
      <div class="left-inner auto-height form-search">
        ...
        <form action="<?php print $form['#action']?>" method="post" id="<?php print $form['#form_id']?>" >
            <input class="form-control" type="text" name="<?php print $form['search_block_form']['#name'] ?>" value="<?php if(!empty($form['keyword']['#value']))print $form['keyword']['#value']?>" results="0" placeholder="Pretra&#382;i  <?php print strtolower($form['content_type']['#value']); ?>...">
        ...
        <span class="search-all-label">Stisnite ikonu pretrage kako biste vidjeli sav sadr&#382;aj u ovoj kategoriji</span>
        <?php endif; ?>
      </div>
    </div>
