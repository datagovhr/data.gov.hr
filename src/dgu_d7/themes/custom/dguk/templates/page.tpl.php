        ...
        <a class="brand" href="/" rel="home">
          <!--
            <div id="dgu-header" class="retina-img">
                <img src="/assets/img/dgu-header-cropped.png" alt="DATA.GOV.HR - Opening up Government" />
            </div>
            -->
        </a>
      ...
      <div class="chevron position<?php print $active;?>"></div>
        <nav id="dgu-nav">
          ...
          <div class="text-links">
            <a href="/" title="" class="trigger-subnav nav-home <?php if($active == 1) print 'active'; ?>">Poèetna</a>
          ...
          <div class="nav-search" style="width: 200px;">
            <form class="input-group input-group-sm" action="/data/search">
              <input type="text" class="form-control" name="q" placeholder="Pretraži podatke...">
