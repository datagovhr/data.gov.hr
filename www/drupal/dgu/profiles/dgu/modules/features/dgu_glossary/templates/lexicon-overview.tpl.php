 ...
 *<!--<?php print (if($suggest_new_term_link!="")) ?>-->
 */
?>

<h1 style="margin-top:10px;"><?php print t('Glossary'); ?></h1>
    ...
    <navclass="tabs">
      <!--<div id="menu-tabs">
        <ul  id="<?php print $lexicon_overview->voc_name ?>_filter" class="tabs--primary nav">
          <li><a href="#approved" id="show_approved" data-toggle="tab"><?php print t('Approved terms'); ?></a></li>
          <li><a href="#new" id="show_new" data-toggle="tab"><?php print t('New terms'); ?></a></li>
          <li class="active"><a href="#both" id="show_both" data-toggle="tab"><?php print t('All terms'); ?></a></li>
        </ul>-->
