...
<div class="user-info row"<?php print $attributes; ?>>
  <div class="profile col-md-4">
    <h3><?php print t('About').' '.$elements['#account']->name?></h3>
    ...
    <!--<?php if($stats): ?>
		<h3><?php print t('User activity statistics'); ?></h3>
        <?php print $stats; ?>
    <?php endif; ?>-->
  ...
  <?php if($recent_content): ?>
    <div class="user-engagement col-md-4">
        <h3><?php print t('Recent content'); ?></h3>
          <?php print $recent_content; ?>
    </div>
  <?php endif; ?>
  <!--<?php if($recent_comments): ?>
    <div class="user-engagement col-md-4">
		<h3><?php print t('Recent comments'); ?></h3>
