...
<div class="views-field views-field-stats forum-category-stats">
    <span><span class="counter"><?php print $fields['nid']->raw; ?></span> teme</span>
  <?php if ($new_topics): ?>
    <span class="new"><?php print $new_topics; ?> nova</span>
  <?php endif; ?>
  <?php if (isset($fields['id']->raw)): ?>
      <span><span class="counter"> <?php print $fields['id']->raw; ?></span> odgovori</span>
      <?php $new_replies = dgu_forum_replies_unread($row->tid); ?>
      <?php if ($new_replies): ?>
        <span class="new"><?php print $new_replies; ?> nova</span>
      <?php endif; ?>
  <?php endif; ?>
</div>