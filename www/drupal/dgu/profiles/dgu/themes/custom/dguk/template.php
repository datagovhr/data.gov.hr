...
function dguk_preprocess_node(&$variables) {
  ...
  if ($variables['node']->type == 'resource'){
    $variables['submitted'] = t('Submitted on ') . format_date($variables['changed'], 'short','d.m.Y');
  }
