...
<div class="blog-posts">
  ...
  <div class="views-field views-field-name">
    <span class="views-label views-label-name">Kreiran od </span><?php print $fields['name']->content . ' ' . $fields['created']->content; ?>
  </div>
...
<div class="blog-posts-comments">
  ...
  <?php else: ?>
    <p class="no-replies grey-text">Nema komentara</p>
  <?php endif; ?>
</div>
