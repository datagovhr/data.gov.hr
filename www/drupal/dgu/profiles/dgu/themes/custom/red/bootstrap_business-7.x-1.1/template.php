 ...
 */
function Hr_Gov_preprocess_html(&$variables){
 ...
 */
function Hr_Gov_preprocess_page(&$variables) {
 ...
 */
function Hr_Gov_preprocess_node(&$variables) {
  ...
  if ($variables['node']->type == 'forum' || $variables['node']->type == 'blog') {
    ...
    if (!empty($user->field_avatar)) {
      ...
      $image_info = Hr_Gov_default_field_image('field_avatar');
 ...
 */
function Hr_Gov_preprocess_panels_pane(&$variables) {
 ...
 */
function Hr_Gov_preprocess_block(&$variables) {
  $variables['classes_array'][] = 'boxed';
}
 ...
 */
function Hr_Gov_preprocess_field(&$variables) {
 ...
 */
function Hr_Gov_preprocess_reply(&$variables) {
  global $user;
 ...
 */
function Hr_Gov_preprocess_replies(&$variables) {
 ...
 */
function Hr_Gov_preprocess_search_result(&$variables) {
  $variables['classes_array'][] = 'boxed';
 ...
 */
function Hr_Gov_default_field_image($field_name) {
 ...
 */
function Hr_Gov_form_alter(&$form, &$form_state, $form_id) {
  switch ($form_id) {
    case 'user_pass':
    case 'user_login':
...
function Hr_Gov_get_data_menu() {
  ...
  if ($user->uid == 1 || in_array('ckan adminstrator', array_values($user->roles))) {
    $admin_menu = array(
      ...
      'menu-system-dashboard' => array(
        'title' => 'Kontrolna ploca sustava',
        'href' => 'data/system_dashboard',
      ),
      'menu-harvest' => array(
        'title' => 'Prikupi Izvore',
        'href' => 'harvest',
      ),
      'menu-feedback-moderation' => array(
        'title' => 'Povratne Informacije Moderiranja',
  ...
  if(Hr_Gov_get_search_content_type() == 'dataset_request') {
...
function Hr_Gov_get_search_content_type() {
 ...
 */
function Hr_Gov_get_apps_menu($menu) {
	//$menu = menu_navigation_links('menu-apps');
  $classes = array('subnav', 'subnav-apps');
  if (Hr_Gov_get_search_content_type() == 'app') {
    $classes[] = 'active';
 ...
 */
function Hr_Gov_get_interact_menu($menu) {
  $classes = array('subnav', 'subnav-interact');
  $bundle_facet = Hr_Gov_get_search_content_type();
 ...
 */
function Hr_Gov_get_footer_menu() {
 ...
 * @see Hr_Gov/templates/html.tpl.php
 */
function Hr_Gov_js_alter(&$js){
 ...
 */
function Hr_Gov_breadcrumb($variables) {
...
function Hr_Gov_field__field_quality__glossary($variables) {
  $output = '';
 ...
 */
function Hr_Gov_menu_local_tasks(&$variables) {
  $output = '';
...
function Hr_Gov_facetapi_title($variables) {
 ...
 */
function Hr_Gov_panels_default_style_render_region($vars) {
  $output = '';
  $counter = 0;
 ...
 * To get rid of '(-)'.
 */
function Hr_Gov_facetapi_link_active($variables) {
 ...
 */
function Hr_Gov_pager($variables) {
 ...
 */
function Hr_Gov_preprocess_region(&$variables) {
